        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(
                ...
                if args.delta:
                    ...
                    segment_ids = segment_ids.checkpoint()
                    start_positions = start_positions.checkpoint()
                    end_positions = end_positions.checkpoint()
                ...
                if args.delta:
                    ...
                    input_mask = input_mask.decheckpoint()
                    segment_ids = segment_ids.decheckpoint()
                    start_positions = start_positions.decheckpoint()
                    end_positions = end_positions.decheckpoint()
